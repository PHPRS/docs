## Codigo de Conduta da Comunidade de desenvolvedores PHP do estado de Rio Grande do Sul
...
> Nosso código de conduta pode ser encontrado na íntegra em [https://github.com/PHPRS/docs/blob/master/codigo-de-conduta.md].

### Versões longas e específicas 

Código de Conduta Geral da Comunidade: [https://github.com/PHPRS/docs/blob/master/codigo-de-conduta-comunidade.md]
Código de Conduta para Eventos: [https://github.com/PHPRS/docs/blob/master/codigo-de-conduta-eventos.md]